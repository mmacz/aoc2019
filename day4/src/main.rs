...
static SANITY_INPUTS_2: &'static [(i32, bool)] = &[(112233, true), (123444, false), (111122, true)];
...
fn puzzle_check(can_group: bool) -> u32 {
    ...
    for pass in 172930..683082 {
        valid_count += if validate_password(pass, can_group) {
            1
        } else {
            0
        };
